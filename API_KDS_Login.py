...
print("\033[1;34m KDS LOGIN TESTCASE! Document ID: TP_001\033[0m")
...
oms_privilege_payload ={
    "loginId": "AutotestOMS",
    "password": "Smm@1234"
}

response_login = requests.post(login_url,json=oms_privilege_payload)
if response_login.status_code == 200:
    response_json = response_login.json()
    failed_count+=1
    # print(failed_count,"f")
...
invalid_login_payload = {
    "loginId": "AutotestKDS",   # ✅ Use "loginId" only if this is accepted by the API (otherwise use "username")
    "password": "Smm@1234"
}
...
if admin_login.status_code == 200:
    ...
    if response_create.status_code != 201:
        ...
        user1 = requests.post(login_url, json={"loginId":"kdstest" , "password":"Smm@1234"})
...
if response_check_A.status_code == 200:
    ...
    print("\033[91m❌ TEST FAILED...! : Test Case ID - 012  :  Error - Unauthorized Access \033[0m")

else:
    # print("\033[92m✅ Device A token was rejected after Device B login. : Test Case ID - 020 \033[0m")
    print("\033[92m✅ TEST PASSED...! : Test Case ID - 012 \033[0m",response_check_A.status_code)
