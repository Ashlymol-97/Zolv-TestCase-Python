...
if response_login.status_code == 200:
    ...
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_01 \033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_01 : Error - Invalid Credentials \033[0m") # login failed so test passed
...
if response_invalidlogin.status_code == 200:
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_02 : Error - Invalid Credentials \033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms

    # print(f"Token (Login): {token1}") 

else:
    # print(f"\033[92m✅  Login failed with status code {response_login.status_code}\033[0m",{"loginId":loginid,"password":pwd})
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_02 \033[0m") # login failed so test passed
...
# 3 : Un Authorized User (Privilege) :
...
for user in Unauthorized_payload:
    ...
    if login_Auth.status_code != 200:
        print("\033[92m✅ TEST PASSED...! : Test Case ID - GIN_03 \033[0m")
        ...
        if c!=0 and c<=1:
           ...
           error_message={"Un"}
        #    print(failed_count,"f")
        print("\033[91m❌ TEST FAILED...! : Test Case ID - GIN_03 : Error - Unauthorized user \033[0m")
            ...
            if user["loginId"] == username_input:
                ...
                if is_active:
                    ...
                    if user_login.status_code != 200:
                        ...
                        print(f"\033[92m✅ Test Passed...! : Test Case ID - GIN_04 \033[0m")

                    else:
                        # print(f"\033[91m❌ Test Failed: Inactive user {username_input} was able to login!\033[0m")
                        failed_count+=1
                        print(f"\033[91m❌ Test Failed...! : Test Case ID - GIN_04 : Error - The user is currently inactive\033[0m")
        ...
        if admin_login.status_code == 200:
            ...
            if delete_response.status_code == 200:
                ...
                if deleted_login.status_code != 200:
                    print("\033[92m✅ TEST PASSED...! : Test Case ID - GIN_05 \033[0m")
                    # print("\033[92m✅ TEST PASSED :  Deleted user login correctly blocked (401 Unauthorized) : Test Case ID - 009\033[0m")
                else:
                    failed_count+=1
                    print("\033[91m❌ TEST FAILED...! : Test Case ID - GIN_05 : Error - User not found \033[0m")
...
if response_login.status_code == 200:
    ...
    print("\033[91m❌ TEST FAILED...! : Test Case ID - GIN_06 : Error - Unauthorized user \033[0m")
else:
    print("\033[92m✅ TEST PASSED...! : Test Case ID - GIN_06 \033[0m")
...
if response_login.status_code == 200:
    ...
    # print("Response JSON : ",json.dumps(response_json,indent=4))
    print("\033[91m❌ TEST FAILED...! : Test Case ID - GIN_07 : Error - Unauthorized user  \033[0m")
else:
    print("\033[92m✅ TEST PASSED...! :  Test Case ID - GIN_07 \033[0m")
...
# # 8 : Login with additional field in payload : 
...
if response_login.status_code == 200:
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_08 : Error - Unexpected fields in payload \033[0m") # login failed so test passed
    ...
    print("\033[1;92m✅ TEST PASSED...! : Test Case ID - GIN_08 \033[0m")
    # print("Response:", response_login.json())
...
#  9 : Login with extremely long payload :
...
if response_login.status_code != 200:
    ...
    print("\033[1;92m✅ TEST PASSED...! : Test Case ID - GIN_09 \033[0m")

    # print("Response:", response_login.json())
else:
    failed_count+=1
    # print(f"\033[91m❌ Login succeeded with long credentials. \033[0m",response_login.status_code) # login failed so test passed
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_09 : Error - Payload too large \033[0m") # login failed so test passed
...
# 10 : Login with empty field in payload  : 
...
if response_login.status_code == 200:
    ...
    token1= response_json.get('token',{}).get('token')
    # print(f"\033[91m❌  Login successful for: {loginid} | Name: {name} | Status: {response_login.status_code}\033[0m")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_10 : Error -  Fields cannot be empty \033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms

    # print(f"Token (Login): {token1}") 

else:
    # print(f"\033[92m✅ Login failed with status code {response_login.status_code}\033[0m",{"loginId":loginid,"password":pwd})
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_10 \033[0m") # login failed so test passed
...
# 11 : Login with null field in payload : 
...
if response_login.status_code == 200:
    ...
    failed_count+=1
    # print(f"\033[91m❌  Login successful for: {loginid} | Name: {name} | Status: {response_login.status_code}\033[0m")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_11 : Error -  Username and Password fields are required\033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms

    # print(f"Token (Login): {token1}") 

else:
    # print(f"\033[92m✅ Login failed with status code {response_login.status_code}\033[0m",{"loginId":loginid,"password":pwd})
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_11 \033[0m") # login failed so test passed
    # print("Response:", response_login.json())
    # print(f"\033[92m✅ TEST PASSED...!\033[0m") # login failed so test passed
...
# 12 :Login with emoji characters input : 
...
if response_unicode.status_code != 200:
    ...
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_12 \033[0m") 
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_12  :  Error - Invalid characters \033[0m") # login failed so test passed
...
if response_case_sensitivity.status_code != 200:
    ...
    case_sensitivity_token= case_sensitivity_json.get('token',{}).get('token')
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_13 \033[0m") 
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_13  :  Error - Username appears to be case-insensitive  \033[0m") # login failed so test passed
...
if response_login.status_code != 200:
    print("\033[1;92m✅ TEST PASSED...! : Test Case ID - GIN_14 \033[0m")
    # print("Response:", response_login.json())
else:
    failed_count+=1
    # print("TEST PASSED : Test for SQL injection protection failed! SQL injection might be possible.014")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_14 : Error - SQL injection detected \033[0m") # login failed so test passed
...
if response_no_sql_injection.status_code != 200:
    ...
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_15 \033[0m") 
else:
 
    failed_count+=1
    # print(f"\033[91m❌ Login failed with status code {response_no_sql_injection.text}\033[0m")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID : GIN_15  :  Error - Suspicious input detected \033[0m") # login failed so test passed
...
if response_xml_injection.status_code != 200:
    ...
    print("\033[1;92m✅ TEST PASSED...! : Test Case ID - GIN_16 \033[0m")
    ...
    print("\033[91m❌ TEST FAILED...! : Test Case ID - GIN_16 : Error - XML injection detected \033[0m")
...
for invalid in Invalidparams_login_payload:
    ...
    if response_invalidlogin.status_code == 200:
        ...
        token1= invalid_json.get('token',{}).get('token')
        # print(f"\033[91m❌  Login successful for: {loginid} | Name: {name} | Status: {response_login.status_code}\033[0m")
        print(f"\033[91m❌ TEST FAILED...! : Test Case ID - GIN_17 : Error - Invalid Input Format\033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms

        # print(f"Token (Login): {token1}") 

    else:
        # print(f"\033[92m✅  Login failed with status code {response_login.status_code}\033[0m",{"loginId":loginid,"password":pwd})
        print(f"\033[92m✅ TEST PASSED...! : Test Case ID - GIN_17 \033[0m") # login failed so test passed
...
if response_invalid_method.status_code != 200:
    ...
    print("\033[1;92m✅ TEST PASSED...! : Test Case ID - GIN_18 \033[0m")
else:
    failed_count+=1
    print("\033[1;91m❌ TEST FAILED...! : Test Case ID -  GIN_18  : Error - API should only allow POST for login \033[0m")
...
if response_login.status_code == 200:
    ...
    token1= response_json.get('token',{}).get('token')
    # print(f"\033[91m❌  Login successful for: {loginid} | Name: {name} | Status: {response_login.status_code}\033[0m")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - 001 : Error - Login ID required \033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms

    # print(f"Token (Login): {token1}") 

else:
    # print(f"\033[92m✅ Login failed with status code {response_login.status_code}\033[0m",{"loginId":loginid,"password":pwd})
    print(f"\033[92m✅ TEST PASSED...! : Test Case ID - 001 \033[0m") # login failed so test passed
...
if response_login.status_code == 200:
    ...
    # print(f"\033[91m❌  Login successful for: {loginid} | Name: {name} | Status: {response_login.status_code}\033[0m")
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - 002 : Error - Password required \033[0m") # login success so test failed becoz in oms logged with oms in other 3 credentials kds,go,testoms
...
# 3 : Login with special characters input in Login ID (username):
...
if response_special_chars.status_code != 200:
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - 003  :  Error - Special characters not allowed in Login Id \033[0m") # login failed so test passed
    # print("Test for special characters in username failed! Login succeeded with special characters.")
...
#4 : Login from Device B using same credentials while Device A login is active (multiple device Login behaviour) :
...
if response_check_a.status_code == 200:
    ...
    print("\033[91m❌ TEST FAILED...! : Test Case ID - 004  :  Error - Unauthorized \033[0m")

else:
    # print("\033[92m✅ Device A token was rejected after Device B login. : Test Case ID - 020 \033[0m")
    print("\033[92m✅ TEST PASSED...! : Test Case ID - 004 \033[0m")
...
# 5 : Login with malformed JSON request : 
...
if response_malformed_json.status_code != 200:
    ...
    print(f"\033[91m❌ TEST FAILED...! : Test Case ID - 005  :  Error - Invalid JSON \033[0m") # login failed so test passed
...
# 6 :   Invalid API endpoint (intentionally wrong) : 
...
if response.status_code == 200:
    ...
    failed_count+=1
    print("\033[91m❌ TEST FAILED...! : Test Case ID - 006 : Error - Invalid API endpoint\033[0m")
else:
...
# 8 : Database down during login 

print("\033[1;93mTest Case ID -  008 :  Skipping DB Availability....\033[0m")





# 9 : Login when Redis is Down
        
print("\033[1;93mTest Case ID -  09 : Skipping Cache...\033[0m")
